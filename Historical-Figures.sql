...
more than simple calculations,perhaps even write music.",2,2),
...
Mathematical Association, and to be President of the London Mathematical Society.",2,3),
("Rosalind Franklin",1920,1958,"Rosalind Franklin graduated from the University of Cambridge in 1492, with a degree in Natural Sciences. In 1942
 ...
 a degree, as shewas a woman.", 2,null),
 ...
 Royal Society and President of the International Union of Crystallography.",2,null),
 ...
 including Ibn Sina, Al-Kindi, Al-Farabi, and Abu al-Wafa' Buzjani during the Abbasid Empire.",6,Null),
...
,4,Null),
 ...
 Fermat's last theorem and elasticity theory.",4,Null),
 ...
 She worked on France's first nuclear reactor.",4,Null),
 ...
 discovery of nuclear fission.",7,null),
...
she shared with Johannes Hans Daniel Jensen and Eugene Wigner.",7,null),
...
to Euler, covering both differential and integral calculus.",8,null),
...
the Saruhasi Prize and a L'Oréal-UNESCO Award for Women in Science.",9,null),
...
in Physics, initially naming only her husband Pierre Curie and fellow physicist Henri Becquerel.
 ...
 paper. Pierre complained to the commiette and had Marie added to the nomination papers.",10,null),
 ...
 before being submitted for publication.",12,null),
...
Maria reported her work to the Royal Swedish Academy of Sciences(KVA) and applied to various types of
 ...
 and has a Arleigh Burke-class guided-missile destroyer named after her.",5,NULL),
 ...
 Institute of Chemists, and an Award for Creative Invention from the American Chemical Society.",5,Null),
 ...
 work on the mathematics of space flight.",5,null),
 ...
 planes and assisted in the design of the US spacecraft.",5,null),
 ...
 the first woman to be appointed to such a position.",1,null),
 ...
 following year. Her PhD work on Geodesics solved an open problem in The Theory of Relativity.",3,null);
