...
insert into tbl_Historical_People(Name, BirthYear,DeathYear,Description,MainSector,Country_Of_BirthID,BookingsID) Values
...
Mathematical Association, and to be President of the London Mathematical Society.","Mathematics",2,3),
("Rosalind Franklin",1920,1958,"Rosalind Franklin graduated from the University of Cambridge in 1492, with a degree in Natural Sciences. In 1942
 ...
 a degree, as shewas a woman.","Engineer, mathematician, physicist", 2,null),
 ...
 Fermat's last theorem and elasticity theory.","mathematics, physics",4,Null),
 ...
 the universe.","Mathematics, physics",4,null),
 ...
 discovery of nuclear fission.","Chemistry, Physics",7,null),
...
she shared with Johannes Hans Daniel Jensen and Eugene Wigner.","Physics",7,null),
...
to Euler, covering both differential and integral calculus.","mathematics",8,null),
...
the Saruhasi Prize and a L'Oréal-UNESCO Award for Women in Science.","Physics, computing",9,null),
...
in Physics, initially naming only her husband Pierre Curie and fellow physicist Henri Becquerel.
 ...
 Newton.","astronomy, chemistry, and medicine",11,null),
 ...
 before being submitted for publication.","mathematics, physics",12,null),
...
Maria reported her work to the Royal Swedish Academy of Sciences(KVA) and applied to various types of
 ...
 and has a Arleigh Burke-class guided-missile destroyer named after her.","computing",5,NULL),
 ...
 work on the mathematics of space flight.","Mathmatics",5,null),
 ...
 planes and assisted in the design of the US spacecraft.","Mathmatics",5,null),
 ...
 the first woman to be appointed to such a position.","Mathmatics",1,null),
